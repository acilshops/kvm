...
res1() {
wget https://raw.githubusercontent.com/acilshops/kvm/main/install/rmbl.sh && chmod +x rmbl.sh && ./rmbl.sh
clear
}
res2() {
...
echo "║                   Acilshop|Autoscript Tunneling              ║"
echo "╚══════════════════════════════════════════════════════════════╝"
echo -e "\033[0m"
sleep 2
...
download_with_progress "https://raw.githubusercontent.com/acilshops/kvm/main/sshws/insshws.sh" "insshws.sh" "WebSocket SSH"
...
echo -ne "\033[0;33mProgress: \033[0;32m["
wget https://raw.githubusercontent.com/acilshops/kvm/main/noobz/noobzvpns.zip >/dev/null 2>&1 &
local pid=$!
while kill -0 $pid 2>/dev/null; do
    echo -ne "█"
    sleep 0.2
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ"t.me/AcilOffcialt.me/AcilOffcial wa.me/+6287733994799"},{"text":"Chanel","url":"https://t.me/AcilTestimoni"}]]}'

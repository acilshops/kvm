#!/bin/bash
# // PROJECT STORE
url_izin="https://raw.githubusercontent.com/yasrilpujianto-ship-it/admin/main/ip"
...
git clone https://github.com/yasrilpujianto-ship-it/ip.git /root/ipvps/ &> /dev/null
clear
echo -e ""

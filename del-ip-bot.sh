#!/bin/bash
# Token yasrilpujianto-ship-it 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
    TOKEN="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"
    git clone https://github.com/yasrilpujianto-ship-it/ip /root/ipvps/ &> /dev/null
    clear
    echo ""
    ...
    git config --global user.name "yasrilpujianto-ship-it" &> /dev/null
    rm -rf .git &> /dev/null
    git init &> /dev/null
    git add . &> /dev/null
    git commit -m register &> /dev/null
    git branch -M main &> /dev/null
    git remote add origin https://github.com/yasrilpujianto-ship-it/ip
    git push -f https://${TOKEN}@github.com/yasrilpujianto-ship-it/permission.git &> /dev/null
    rm -rf /root/ipvps
    clear
    sleep 1
